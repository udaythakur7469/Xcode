  ...
  return (
    <>
      <div className="flex flex-row flex-1 items-center w-full">
        <div className="flex flex-row flex-1 items-center bg-muted rounded-xl py-2 px-1 w-full gap-2">
          <div className="ml-1">
            <NotebookText />
          </div>
          {solutionAvailable ? (
          ...
          <div
            className={
              solutionAvailable
                ? "cursor-pointer bg-green-600 flex flex-row items-center rounded-xl px-2 text-[#FDFBD4] ml-auto gap-1 select-none"
                : "cursor-not-allowed select-none hover:opacity-50 bg-green-600 flex flex-row items-center rounded-xl px-2 text-[#FDFBD4] ml-auto gap-1"
            }
            onClick={() => {
