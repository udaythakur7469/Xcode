...
export default function ContestLobby() {
  ...
  const { activeContest, loadingContest, fetchContestBySlug, registerForContest } = useContestStore();
  ...
  if (loadingContest || !activeContest) {
    return <div className="w-full px-5 pt-10 text-muted-foreground">Loading contest…</div>;
  }
