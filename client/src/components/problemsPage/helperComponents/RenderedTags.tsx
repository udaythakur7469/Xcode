...
const RenderedTags: React.FC<RenderedTagsProps> = ({ tagName, onRemove }) => {
  return (
    <button
      className={`${
        tagName === "Deselect All" ? "bg-red-600" : "bg-blue-600"
      } text-white px-2 py-1 rounded-lg flex flex-row justify-center items-center gap-2 hover:${
        tagName === "Deselect All" ? "bg-red-700" : "bg-blue-700"
