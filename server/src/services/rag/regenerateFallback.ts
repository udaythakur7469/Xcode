...
const selectStrategy = (previousRetrievalConfidence: number): RetryStrategy => {
...
export const buildRegenerateStrategy = (
  input: RegenerateStrategyInput,
): RegenerateStrategyResult => {
  const {
    normalizedMessage,
    problemTitle,
