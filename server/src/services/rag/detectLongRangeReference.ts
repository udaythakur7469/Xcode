...
import { LongRangeReferenceResult } from "./types.js";
...
const LONG_RANGE_PATTERNS: Array<{ pattern: RegExp; signal: string; weight: number }> = [
...
const WEAK_PATTERNS: Array<{ pattern: RegExp; signal: string; weight: number }> = [
  { pattern: /\bagain\b/i,  signal: "again",  weight: 0.3 },
  { pattern: /\babove\b/i,  signal: "above",  weight: 0.3 },
];

export const detectLongRangeReference = (
  userMessage: string,
): LongRangeReferenceResult => {
