...
import { verifyAccessToken, verifyRefreshToken, } from "../utils/tokenAndCookie.js";
...
export const initSocket = (httpServer) => {
    ...
    io.on("connection", (socket) => {
        logger.info(`Socket connected: ${socket.id} | userId: ${socket.data.userId ?? "guest"}`);
