...
const FALLBACK_MESSAGES = {
    [RefusalStyle.ENCOURAGING]: "I know this problem can be challenging, but I can't provide that yet. Working through it yourself will really solidify your understanding.",
    [RefusalStyle.NEUTRAL]: "I'm not able to provide that at this stage. Please continue working on the problem.",
    [RefusalStyle.DIRECT]: "I can't help with that right now. Please keep working on the problem.",
    [RefusalStyle.MINIMAL]: "Please solve it first.",
};
// ============================================================
// buildDenialPrompt
//
...
// ============================================================
const buildStyleGuidance = (style, attemptCount) => {
    switch (style) {
...
// ============================================================
const buildSafetyOverrides = (confidenceScore, attemptCount) => {
    const overrides = [];
    if (confidenceScore < 0.5) {
        overrides.push("LOW CONFIDENCE OVERRIDE: The intent was ambiguous. Be more conservative — do not provide any contextual information that could be interpreted as a hint.");
    }
    if (attemptCount > 2) {
        overrides.push("REPEATED ATTEMPT OVERRIDE: The user has made multiple attempts to get this information. Do not soften the refusal regardless of tone style. Keep it brief.");
    }
...
// ============================================================
const sanitizeDenialResponse = (raw) => {
...
// ============================================================
export const generateDenialResponse = async (ctx) => {
