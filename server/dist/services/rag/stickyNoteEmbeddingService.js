...
function buildEmbedText(title, content) {
...
export async function upsertStickyNoteEmbedding(input) {
...
export async function deleteStickyNoteEmbedding(noteId) {
    try {
        const index = pc.index(PINECONE_INDEX).namespace(STICKY_NAMESPACE);
...
export async function bulkSyncStickyNoteEmbeddings(notes) {
    let success = 0;
    let failed = 0;
