...
// ============================================================
export const getRefusalState = async (userId, problemId) => {
    try {
...
// ============================================================
export const upsertRefusalState = async (userId, problemId, nextState) => {
    try {
...
// ============================================================
export const resetRefusalState = async (userId, problemId) => {
    try {
...
// ============================================================
export const resetRefusalStateForBranch = async (userId, problemId, branchRootMessageId) => {
    try {
        await prisma.refusalState.upsert({
            where: {
                userId_problemId: { userId, problemId },
