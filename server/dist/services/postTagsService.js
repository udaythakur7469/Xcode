...
export const addTagToCloudinary = async (newTag) => {
    try {
        ...
        const exists = existingTags.some((existingTag) => existingTag.toLowerCase().trim() === normalizedNewTag);
        let addedTag = null;
        ...
        if (!exists) {
            ...
            combinedTags.sort((a, b) => a.toLowerCase().localeCompare(b.toLowerCase()));
