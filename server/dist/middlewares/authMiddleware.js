...
import { generateAccessTokenAndSetCookie, generateRefreshTokenAndSetCookie, verifyAccessToken, verifyRefreshToken, } from "../utils/tokenAndCookie.js";
...
export const authMiddleware = async (req, res, next) => {
    ...
    try {
        ...
        if (!refreshTokenPayload) {
            return next(createHttpError.Unauthorized("Invalid session. Please sign in again"));
        }
