...
export const sendMessage = async (req, res, next) => {
    ...
    try {
        ...
        if (regenerate && (!userMessageId || typeof userMessageId !== "string")) {
            throw createHttpError.BadRequest("userMessageId is required when regenerate is true");
        }
        ...
        if (regenerate) {
            ...
            if (existingUserMessage.ChatId !== chatId) {
                throw createHttpError.BadRequest("User message does not belong to this chat");
            }
            if (existingUserMessage.role !== "user") {
                throw createHttpError.BadRequest("Provided messageId is not a user message");
            }
