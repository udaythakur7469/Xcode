...
router
    .route("/")
    .post(authMiddleware, stickyNotesLimiter, cacheMiddleware(redis, { strategy: "none" }), createStickyNote);
router
    .route("/bulk")
    .post(authMiddleware, stickyNotesLimiter, cacheMiddleware(redis, { strategy: "none" }), bulkCreateStickyNotes);
router
    .route("/:id")
    .put(authMiddleware, stickyNotesLimiter, cacheMiddleware(redis, { strategy: "none" }), updateStickyNote);
router
    .route("/:id")
    .delete(authMiddleware, stickyNotesLimiter, cacheMiddleware(redis, { strategy: "none" }), deleteStickyNote);
