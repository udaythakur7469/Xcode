 ...
 */
router.route("/getMessages").get(optionalAuthMiddleware, chatReadLimiter, cacheMiddleware(redis, {
    ttl: 30, // 30 seconds
    autoCache: {
        tags: ["chat:messages"],
        includeAuth: true,
 ...
 */
router.route("/getUserChats").get(optionalAuthMiddleware, chatReadLimiter, cacheMiddleware(redis, {
    ttl: 60, // 60 seconds
    autoCache: {
        tags: ["chat:list"],
        includeAuth: true,
 ...
 */
router.route("/message/:messageId").get(optionalAuthMiddleware, chatReadLimiter, cacheMiddleware(redis, {
    ttl: 30,
    autoCache: {
        tags: ["chat:messages"],
        includeAuth: true,
